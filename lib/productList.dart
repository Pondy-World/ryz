...
class _ProductListState extends State<ProductList> {
  ...
  CartControllerSelf cartControllerSelf = new CartControllerSelf();
  ...
  getCartData() async {
    ...
    for (var cartProducts in cartDataController.cartProducts) {
      print(cartProducts['id']);
      cartids.add(cartProducts['id']);
    }

    setState(() {});
  }

  int getProductCount(id) {
    var result = 0;
    print("*****");
    print(id);
    print("*******");
    for (var cartpds in cartDataController.cartProducts) {
      if (id.toString() == cartpds['id']) result = cartpds['count'];
    }
    return result;
  }
  ...
  Widget build(BuildContext context) {
    ...
    Widget smallScreen() {
      return Scaffold(
        ...
        body: (productController.productList.isEmpty)
            ? Center(
                ...
                slivers: [
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
                      var prodsall = productController.productList[index];
                      return Padding(
                        padding: const EdgeInsets.all(8.0),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: (cartids.contains(prodsall['id'].toString()))
                                          ? Row(
                                              ...
                                              children: [
                                                InkWell(
                                                  onTap: () async {
                                                    ...
                                                    var count = getProductCount(prodsall['id']);
                                                    ...
                                                    if (count == 1) {
                                                      ...
                                                      var pdvproduct = CrtPds2(
                                                          ...
                                                          count: count,
                                                          imageURLValue: prodsall['product_image'],
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    getProductCount(prodsall['id']).toString(),
                                                    style: TextStyle(
                                                        fontSize: 20,
                                                        fontWeight: FontWeight.bold,
                                                        color: Colors.black,
                                          ...
                                          : ElevatedButton(
                                              ...
                                              style: ElevatedButton.styleFrom(
                                                  primary: Colors.blue, textStyle: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                                            ),
                                    )
        ...
        floatingActionButton: Visibility(
            visible: CartControllerSelf().viewProduct().isNotEmpty,
            child: FloatingActionButton.extended(
                onPressed: () => Navigator.pushAndRemoveUntil(
                    context, MaterialPageRoute(builder: (context) => MyHomePage(initialPage: 2,)), (route) => false),
